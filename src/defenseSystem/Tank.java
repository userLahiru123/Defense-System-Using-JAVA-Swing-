...
public class Tank extends JFrame implements Observer{
    ...
    public Tank(MainController obj){
        
        id = String.format("TK %0,4d",++INDEX);
        setTitle("Tank "+id);
        setSize(650,400);
        setResizable(false);
        setLayout(null);
        ...
        ammoAmount = new JSpinner(new SpinnerNumberModel(4000,0,4000,1));
        ...
        image = new ImageIcon(getClass().getResource("assets/tank.gif"));
    ...
    public void sendPositionNotification(MainController obj){
        if(setPosition.isSelected()){
            if(obj.lblDisplayNotify.getText().equals("")){
                obj.lblDisplayNotify.setText("Tank "+id+" is positioned...");
            }else{
                obj.lblDisplayNotify.setText(obj.lblDisplayNotify.getText().trim()+ "\nTank "+id+" is positioned...");
            }
        }else{
            obj.lblDisplayNotify.setText(obj.lblDisplayNotify.getText().trim()+ "\nTank "+id+" is not positioned...");
        }
    }
}